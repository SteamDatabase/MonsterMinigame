...
var g_rgIconMap = {
	"ability_1": 									{ icon: '/assets/minigame/towerattack/U8721VM9p9C2v1o6cKJ4qEnGqnE7IoTQgZI-VTdwyTBeimAcIoxXpgK8bPeslY9pPJIvB5IWW2-452kaM8heLSRgleGHorVWwb1mbacg0bL6DV136-dDUDPhGBHXgmacLef8nQM0MpF8IBukyM1M7cAXB9aR2qBKFA'  },
	"ability_2": 								{ icon: '/assets/minigame/towerattack/U8721VM9p9C2v1o6cKJ4qEnGqnE7IoTQgZI-VTdwyTBeimAcIoxXpgK8bPeslY9pPJIvB5IWW2-452kaM8heLSRgleGGo7VWk-kzO_V91empDlVz7ORGAWDqHhbR1TfHLen4wgZiPcIqcBn0kpYb7cAXB9ZJHRPUDQ' },
	"ability_3": 								{ icon: '/assets/minigame/towerattack/U8721VM9p9C2v1o6cKJ4qEnGqnE7IoTQgZI-VTdwyTBeimAcIoxXpgK8bPeslY9pPJIvB5IWW2-452kaM8heLSRgleGGo7VWk-kzO_V91empDlVz7ORGAWDqHhbR1TfHLen4wgZiPcIqcBn0kpYb7cAXB9ZJHRPUDQ' },
	"ability_4": 							{ icon: '/assets/minigame/towerattack/U8721VM9p9C2v1o6cKJ4qEnGqnE7IoTQgZI-VTdwyTBeimAcIoxXpgK8bPeslY9pPJIvB5IWW2-452kaM8heLSRgleGGo7VWk-kzO_V91empDlVz7ORGAWDqHhbR1TfHLen4wgZiPcIqcBn0kpYb7cAXB9ZJHRPUDQ' },
	"ability_5": 					{ icon: '/assets/minigame/towerattack/happycyto' },
	"ability_6": 			{ icon: '/assets/minigame/towerattack/lucky' },
	"ability_7": 							{ icon: '/assets/minigame/towerattack/lunahealthpotion' },
	"ability_8": 			{ icon: '/assets/minigame/towerattack/goldstack' },
	"ability_9": 				{ icon: '/assets/minigame/towerattack/hourglass' },
	"ability_10": 			{ icon: '/assets/minigame/towerattack/abomb' },
	"ability_11": 				{ icon: '/assets/minigame/towerattack/gmbomb' },
	"ability_12": 				{ icon: '/assets/minigame/towerattack/burned' },
	"ability_13": 						{ icon: '/assets/minigame/towerattack/alive' },
	"ability_14": 							{ icon: '/assets/minigame/towerattack/logiaim' },
	"ability_15": 							{ icon: '/assets/minigame/towerattack/pjkaboom' },
	"ability_16": 				{ icon: '/assets/minigame/towerattack/theorb' },
	"ability_17": 						{ icon: '/assets/minigame/towerattack/ccgold' },
	"ability_18": 	{ icon: '/assets/minigame/towerattack/critical'  },
	"ability_19": 				{ icon: '/assets/minigame/towerattack/fistpump'  },
	"ability_20": 						{ icon: '/assets/minigame/towerattack/VeneticaGoldCoin' },
	"ability_21": 					{ icon: '/assets/minigame/towerattack/swshield' },
	"ability_22":		 					{ icon: '/assets/minigame/towerattack/treasurechest' },
	"ability_23":		 				{ icon: '/assets/minigame/towerattack/healthvial' },
	"ability_24":		 				{ icon: '/assets/minigame/towerattack/sunportal' },
	"ability_25":		 				{ icon: '/assets/minigame/towerattack/twteamrandom' },
	"ability_26":		 					{ icon: '/assets/minigame/towerattack/wormwarp' },
	"ability_27":	 					{ icon: '/assets/minigame/towerattack/cooldown' },
	"element_1":									{ icon: '/assets/minigame/towerattack/shelterwildfire' },
	"element_2":									{ icon: '/assets/minigame/towerattack/waterrune' },
	"element_3":										{ icon: '/assets/minigame/towerattack/Wisp' },
