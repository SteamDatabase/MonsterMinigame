                ...
                var clazz = (function(ProtoBuf, T) {
                    ...
                    function cloneRaw(obj, binaryAsBase64, longsAsStrings,
                        ...
                        if (obj === null || typeof obj !== 'object') {
							// @note Tom Bui: do not want to convert field types to their string values
							var bValveConvertEnumsToStrings = false;
                            if (bValveConvertEnumsToStrings&&fieldType == ProtoBuf.TYPES["enum"]) {
