...
class CTowerAttackPlayer
{
	...
	*/
	...
	public function __construct(
		...
		$CritDamage,
		$Loot,
		CTowerAttackPlayerTechTree $TechTree
	)
	{
...
class CTowerAttackPlayerTechTree
{
	/*
...
class CTowerAttackPlayerTechAbilityItem
{
	/*
...
class CTowerAttackPlayerTechTreeUpgrade
{
	/*
	...
	*/
	...
	public function __construct($GameId)
	{
		...
		$this->Players['76561197990586091'] = new CTowerAttackPlayer(
			...
			0, // crit damage
			array(), // loot
			new CTowerAttackPlayerTechTree( // tech tree
				array(), // upgrades
